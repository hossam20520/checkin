...
class ServiceProviderOneScreen extends GetWidget<ServiceProviderOneController> {
  const ServiceProviderOneScreen({Key? key}) : super(key: key);
    ...
    return  Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                leading: AppbarImage(
                    ...
                    margin: getMargin(left: 32, top: 35, bottom: 27),
                    onTap: () {
                      onTapArrowleft4();
                    }),
                              ...
                              children: [
                                Card(
                                    ...
                                    child: Container(
                                        ...
                                        child: Stack(children: [
                                          CustomImageView(
                                              imagePath: ImageConstant.imgBed11,
                                              height: getSize(45),
                                              width: getSize(45),
                                              alignment: Alignment.center)
                                        ]))),
