...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                                              ...
                                                              padding:
                                                                  getPadding(
                                                                      ...
                                                                      bottom:
                                                                          10),
                                                              child: Text(
                                                                  "msg_search_destinations_filled"
                                                                      .tr,
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapHomehotelsfilledContainer();
                                            },
                                            child: Container(
                                                decoration:
                                                    AppDecoration.fillWhiteA700,
  ...
  onTapSearchdestinations() {
    Get.toNamed(
      AppRoutes.searchDestinationsScreen,
    );
  }

  onTapSearchdestinationsfilled() {
    Get.toNamed(
      AppRoutes.searchDestinationsFilledScreen,
    );
  }
  ...
  onTapRoomsandguests() {
    // Get.bottomSheet(
    //   RoomsAndGuestsBottomsheet(
    //     Get.put(
    //       RoomsAndGuestsController(),
    //     ),
    //   ),
  ...
  onTapSearchresultsOne() {
    Get.toNamed(
      AppRoutes.searchResultsOneScreen,
    );
  }
